...
class Ferret_Admin {
    ...
    public function validate_settings() {
        ...
        $valid[$this->options->dsn_field_name] =
            isset( $data[$this->plugin_name][$this->options->dsn_field_name] )
                ? trim( esc_html( $data[$this->plugin_name][$this->options->dsn_field_name] ) )
                : '';
        $valid[$this->options->project_field_name] =
            isset( $data[$this->plugin_name][$this->options->project_field_name] )
                ? trim( esc_html(
                $data[$this->plugin_name][$this->options->project_field_name] ) )
                : '';
        $valid[$this->options->enable_js_field_name] =
            isset( $data[$this->plugin_name][$this->options->enable_js_field_name] )
            ? (bool) $data[$this->plugin_name][$this->options->enable_js_field_name]
            : false;
        $valid[$this->options->environment_field_name] =
            isset( $data[$this->plugin_name][$this->options->environment_field_name] )
            ? (bool) $data[$this->plugin_name][$this->options->environment_field_name]
            : false;
